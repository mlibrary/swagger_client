...
# Unit tests for SwaggerClient::COUNTERTitleUsage
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'COUNTERTitleUsage' do
  before do
    # run before each test
    @instance = SwaggerClient::COUNTERTitleUsage.new
  end
  ...
  describe 'test an instance of COUNTERTitleUsage' do
    it 'should create an instance of COUNTERTitleUsage' do
      expect(@instance).to be_instance_of(SwaggerClient::COUNTERTitleUsage)
    end
  end
