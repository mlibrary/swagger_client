...
# Unit tests for SwaggerClient::COUNTERItemReport
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'COUNTERItemReport' do
  before do
    # run before each test
    @instance = SwaggerClient::COUNTERItemReport.new
  end
  ...
  describe 'test an instance of COUNTERItemReport' do
    it 'should create an instance of COUNTERItemReport' do
      expect(@instance).to be_instance_of(SwaggerClient::COUNTERItemReport)
    end
  end
