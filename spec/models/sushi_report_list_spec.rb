...
# Unit tests for SwaggerClient::SUSHIReportList
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SUSHIReportList' do
  before do
    # run before each test
    @instance = SwaggerClient::SUSHIReportList.new
  end
  ...
  describe 'test an instance of SUSHIReportList' do
    it 'should create an instance of SUSHIReportList' do
      expect(@instance).to be_instance_of(SwaggerClient::SUSHIReportList)
    end
  end
