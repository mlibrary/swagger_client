...
# Unit tests for SwaggerClient::COUNTERItemComponent
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'COUNTERItemComponent' do
  before do
    # run before each test
    @instance = SwaggerClient::COUNTERItemComponent.new
  end
  ...
  describe 'test an instance of COUNTERItemComponent' do
    it 'should create an instance of COUNTERItemComponent' do
      expect(@instance).to be_instance_of(SwaggerClient::COUNTERItemComponent)
    end
  end
