...
# Unit tests for SwaggerClient::COUNTERDatabaseUsage
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'COUNTERDatabaseUsage' do
  before do
    # run before each test
    @instance = SwaggerClient::COUNTERDatabaseUsage.new
  end
  ...
  describe 'test an instance of COUNTERDatabaseUsage' do
    it 'should create an instance of COUNTERDatabaseUsage' do
      expect(@instance).to be_instance_of(SwaggerClient::COUNTERDatabaseUsage)
    end
  end
