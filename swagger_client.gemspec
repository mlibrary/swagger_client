...
Gem::Specification.new do |s|
  ...
  s.email       = ["nisohq@niso.org"]
  s.homepage    = "https://github.com/swagger-api/swagger-codegen"
  s.summary     = "COUNTER_SUSHI5_0 API Ruby Gem"
  s.description = "The COUNTER_SUSHI5_0 API represents a RESTful implementation of SUSHI automation intended to return COUNTER Release 5 reports and snippets of COUNTER usage in JSON format"
