...
module SwaggerClient
  ...
  class COUNTERItemDates
    attr_accessor :type

    # Value of the item date
    attr_accessor :value
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ["Publication_Date"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["Publication_Date"])
