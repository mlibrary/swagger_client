...
module SwaggerClient
  # Defines the output for the Report_Items being returned in an Item Report.
  class COUNTERItemUsage
    ...
    # Publication or other date(s)related to the item.
    ...
    # The identifier for the report item (title)
    attr_accessor :item_parent

    # The identifier for the report item (title)
    attr_accessor :item_component
    ...
    def self.swagger_types
      {
        ...
        :'item_parent' => :'Array<COUNTERItemParent>',
        :'item_component' => :'Array<COUNTERItemComponent>',
        :'data_type' => :'String',
        :'section_type' => :'String',
        :'yop' => :'String',
        :'access_type' => :'String',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'Item_Parent')
        if (value = attributes[:'Item_Parent']).is_a?(Array)
          self.item_parent = value
        end
      end

      if attributes.has_key?(:'Item_Component')
        if (value = attributes[:'Item_Component']).is_a?(Array)
          self.item_component = value
        end
      end
    ...
    def valid?
      ...
      section_type_validator = EnumAttributeValidator.new('String', ["Article", "Book", "Chapter", "Other", "Section"])
    ...
    def section_type=(section_type)
      validator = EnumAttributeValidator.new('String', ["Article", "Book", "Chapter", "Other", "Section"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          item_parent == o.item_parent &&
          item_component == o.item_component &&
    ...
    def hash
      [item, item_id, item_contributors, item_dates, item_attributes, platform, publisher, publisher_id, item_parent, item_component, data_type, section_type, yop, access_type, access_method, performance].hash
    end
