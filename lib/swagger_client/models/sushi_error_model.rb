...
module SwaggerClient
  ...
  class SUSHIErrorModel
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'Help_URL')
    ...
    def valid?
      ...
      severity_validator = EnumAttributeValidator.new('String', ["Warning", "Error", "Fatal", "Debug", "Info"])
    ...
    def severity=(severity)
      validator = EnumAttributeValidator.new('String', ["Warning", "Error", "Fatal", "Debug", "Info"])
    ...
    def hash
      [code, severity, message, help_url, data].hash
    end
