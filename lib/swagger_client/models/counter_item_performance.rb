...
module SwaggerClient
  ...
  class COUNTERItemPerformance
    ...
    def self.swagger_types
      {
        :'period' => :'COUNTERItemPerformancePeriod',
        :'instance' => :'Array<COUNTERItemPerformanceInstance>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'Instance')
        if (value = attributes[:'Instance']).is_a?(Array)
          self.instance = value
        end
      end
